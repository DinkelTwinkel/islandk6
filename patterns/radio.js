...
module.exports = async (client) => {
    ...
    client.on(Events.MessageCreate, async (message) => {
        ...
        if (message.channel.id == '1202876942714544148') {
          ...
          //kimoServer.channels.cache.get('1202622607250296832').send('```' + `${message.member.displayName}: ${message.content} [PEACH]` + '```');
        ...
        if (message.channel.id == '1202622607250296832') {
          ...
          //kimoServer.channels.cache.get('1202876942714544148').send('```' + `${message.member.displayName}: ${message.content} [MELON]` + '```');
