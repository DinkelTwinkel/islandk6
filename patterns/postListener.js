...
module.exports = async (client) => {
    ...
    client.on(Events.MessageCreate, async (message) => {
        ...
        if (message.channel.id != '1192955757705052281') return;
    ...
    async function getFortuneCookie(client) {
        ...
        const backRooms = client.guilds.cache.get('1192955466872004669');
        const cookieChannel = backRooms.channels.cache.get('1193293558321520641');
