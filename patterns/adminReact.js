...
module.exports = async (client) => {
    ...
    client.on(Events.MessageReactionAdd, async (reaction, user) => {
        ...
        if (reaction.emoji.name === '⭐') {
            ...
            if (reaction.message.channelId === '1202874614397804605') {
                const promotionChannel = KimoServer.channels.cache.get('1221957962474455090');
                promotionChannel.send (`${messageAuthorMember} Hi this is an automated message. We're going to be promoting Scissorchan DTIYS entries on social media. If you'd like to give your consent for us to share the following image, respond with a YES and you social media link. Thank you. ${reaction.message.attachments.first().url}]}`);    
            }
